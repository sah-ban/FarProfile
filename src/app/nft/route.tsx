...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const imageResponse = new ImageResponse(
      (
        <div tw="flex flex-col w-full h-full bg-[#8660cc] text-3xl justify-center text-[#00FFFF] border-4 border-[#00FFFF]">
    ...
    headers.set(
      "Cache-Control",
      "public, s-maxage=30000, stale-while-revalidate=59"
    );
